<?php
// Arquivo: views/cursos.php (REFATORADO COM CONTROLLER)
...
extract($data);
// $registros, $params, $message, $editData, etc., agora estão disponíveis.
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="cursos.php">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="<?php echo $id_column; ?>" id="modalId" value="0">

                    <div class="mb-3">
                        <label for="modalNome" class="form-label">Nome do Curso *</label>
                        <input type="text" class="form-control" id="modalNome" name="<?php echo $name_column; ?>" required>
                    </div>
                </div>
