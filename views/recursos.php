<?php
// Arquivo: views/recursos.php (REFATORADO)
...
try {
    ...
    if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
        ...
        if ($deleted) {
            $message = "Recurso ID {$id} excluído com sucesso!";
            $message_type = 'success';
        } else {
            $message = "Erro: Recurso ID {$id} não encontrado ou já excluído.";
            $message_type = 'danger';
        }
        ...
        <div class="col-md-8">
            <form method="GET" class="d-flex">
                ...
                <?php if (!empty($params['term'])): ?>
                    <a href="recursos.php" class="btn btn-outline-danger ms-2" title="Limpar Filtro"><i class="fas fa-times"></i> Limpar</a>
                <?php endif; ?>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="modalLabel">Cadastrar Novo Recurso</h5>
