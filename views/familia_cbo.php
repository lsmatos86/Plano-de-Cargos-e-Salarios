<?php
// Arquivo: views/familia_cbo.php (REFATORADO COM HEADER/FOOTER)
...
$breadcrumb_items = [
    'Dashboard' => '../index.php',
    'Gestão de Famílias CBO' => null // Página ativa
];
// NOVO: Informa ao footer.php qual script JS carregar
$page_scripts = ['../scripts/familia_cbo.js'];
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
        ...
        $message = "Família CBO '{$titulo}' {$action_desc} com sucesso!";
