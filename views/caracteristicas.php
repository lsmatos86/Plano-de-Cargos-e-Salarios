<?php
// Arquivo: views/caracteristicas.php (REFATORADO COM HEADER/FOOTER)
...
$authService->checkAndFail('caracteristicas:manage', '../index.php?error=Acesso+negado');
...
$breadcrumb_items = [
    'Dashboard' => '../index.php',
    'Gestão de Características' => null // Página ativa
];
// NOVO: Informa ao footer.php qual script JS carregar
$page_scripts = ['../scripts/caracteristicas.js'];
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
        ...
        $message = "Característica '{$titulo}' {$action_desc} com sucesso!";
            ...
            <table class="table table-striped table-hover table-sm mb-0">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th><?php echo createSortLink($name_column, 'Nome da Característica', $params); ?></th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-info text-white btn-edit" 
                                            ...
                                            data-descricao="<?php echo htmlspecialchars($row['caracteristicaDescricao'] ?? ''); ?>"
                                            title="Editar">
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="modalNome" class="form-label">Nome da Característica *</label>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="modalDescricao" name="caracteristicaDescricao" rows="3"></textarea>
                    </div>
                </div>
